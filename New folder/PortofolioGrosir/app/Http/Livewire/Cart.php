...
class Cart extends Component
{
    ...
    public function render()
    {
        ...
        $products = ModelsProduct::with(['category'])->where('name', 'like', '%'.$this->search.'%')->orWhereHas('category',function($query){$query->where('name', 'like', '%'.$this->search.'%');})->inRandomOrder()->paginate(4);
        // dd($products);
